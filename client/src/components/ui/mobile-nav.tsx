    ...
    <>
      <div className="md:hidden fixed bottom-0 left-0 right-0 bg-white border-t border-neutral-200 flex justify-around py-2 z-10">
        <Link href="/calendar">
          <a
            className={`flex flex-col items-center pt-1 pb-0.5 ${
              location === "/calendar" ? "text-primary" : "text-neutral-500"
            }`}
          >
            <CalendarDays className="text-xl" size={20} />
            <span className="text-xs mt-0.5">{t("app.calendar")}</span>
          </a>
        </Link>
        ...
        <Link href="/tasks">
          <a
            className={`flex flex-col items-center pt-1 pb-0.5 ${
              location === "/tasks" ? "text-primary" : "text-neutral-500"
            }`}
          >
            <CheckSquare className="text-xl" size={20} />
            <span className="text-xs mt-0.5">{t("app.tasks")}</span>
          </a>
        </Link>
        ...
        <Link href="/partners">
          <a
            className={`flex flex-col items-center pt-1 pb-0.5 ${
              location === "/partners" ? "text-primary" : "text-neutral-500"
            }`}
          >
            <Users className="text-xl" size={20} />
            <span className="text-xs mt-0.5">{t("app.partners")}</span>
          </a>
        </Link>
        ...
        <Link href="/settings">
          ...
          >
            ...
            <span className="text-xs mt-0.5">{t("app.settings")}</span>
          </a>
        </Link>
      </div>
