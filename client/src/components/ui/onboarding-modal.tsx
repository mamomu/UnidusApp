          ...
          <div className="p-6">
            {step === 1 && (
              <>
                ...
                <p className="text-neutral-600 mb-6 text-center">
                  Let's connect your calendars to get started.
                </p>
            ...
            {step === 2 && (
              <>
                ...
                <p className="text-neutral-600 mb-6 text-center">
                  Share your calendar with someone close to collaborate.
                </p>
            ...
            {step === 3 && (
              <>
                ...
                <p className="text-neutral-600 mb-6 text-center">
                  Your calendar is ready to use. Start by creating your first
                  event.
                </p>
                ...
                <div className="bg-neutral-50 p-4 rounded-lg mb-6">
                  ...
                  <ul className="space-y-2 text-sm text-neutral-600">
                    <li className="flex items-start">
                      ...
                      <span>
                        Events are organized by time periods: Morning,
                        Afternoon, and Night
                      </span>
                    </li>
                    <li className="flex items-start">
                    ...
                    <li className="flex items-start">
                      ...
                      <span>
                        Comment and react to events for better collaboration
                      </span>
                    </li>
                  </ul>
                </div>
